...
### Helpers
################################################################################
def get_half_planes(n):
    """
    Generated a list of horizontal and vertical half planes of size (n,n)
    """
    half_plane_x = np.zeros((n, n), dtype=np.float32)
    half_plane_x[:,n//2:] = 1.0 
    half_plane_y = x_half_plane.T
    
    return half_plane_x, half_plane_y