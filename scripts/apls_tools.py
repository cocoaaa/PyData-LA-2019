...
def convert_to_8Bit(inputRaster, outputRaster,
    ...
    if verbose: print("Conversin command:", cmd)
    ...
    try:
        ...
        print("="*80)
        print("input: ", inputRaster)
        print("converion to 8bit error: ", e.returncode)     
    return
...
def gdf_to_array(gdf, im_file, output_raster, burnValue=150):
    ...
    outLayer = outDataSource.CreateLayer("mask", raster_srs, 
