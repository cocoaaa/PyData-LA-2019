...
class unetUp(nn.Module):
    ...
    def forward(self, inputs1, inputs2):
        ...
        h2, w2 = outputs2.shape[-2:]
        nx_pad, ny_pad = w2 - w1, h2 - h1
        pad_x0, pad_y0 = nx_pad//2, ny_pad//2
        pad_x1, pad_y1 = nx_pad - pad_x0, ny_pad - pad_y0
        padding =[]
        outputs1 = F.pad(inputs1, [pad_x0, pad_x1, pad_y0, pad_y1])
